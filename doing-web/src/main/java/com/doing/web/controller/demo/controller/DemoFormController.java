package com.doing.web.controller.demo.controller;

import com.doing.common.annotation.DataSource;
import com.doing.common.core.bean.AjaxResult;
...
/**
 * @Effect demo的Controller
 * @Author doing
 * @Date 2019/12/4 23:17
 * @Version 0.0.1
 **/
@Controller
...
public class DemoFormController
{
    ...
    {
        users.add(new UserFormModel(1, "1000001", "测试1", "15111111111"));
        users.add(new UserFormModel(2, "1000002", "测试2", "15222222222"));
        users.add(new UserFormModel(3, "1000003", "测试3", "15333333333"));
        users.add(new UserFormModel(4, "1000004", "测试4", "15444444444"));
        users.add(new UserFormModel(5, "1000005", "测试5", "15555555555"));
    }
    ...
    {
        String[] array = { "org 1", "org 2", "org 3", "org 4", "org 5" };
        AjaxResult ajax = new AjaxResult();
